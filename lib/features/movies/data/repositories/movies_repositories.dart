...
class MoviesRepositories extends BaseMoviesRepository
{
  ...
  @override
  Future<Either<Failure, List<Recommendations>>> getRecommendationMovies(RecommendationParameters parameters) async{
    final result= await remoteDataSource.getMovieRecommendations(parameters);
    try
    {
      return Right(result);
