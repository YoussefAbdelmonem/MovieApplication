...
import 'package:movies_application/features/movies/presentation/screens/dummy.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<MovieDetailsController>()
  ...
  builder: (context, state) {
    ...
    return SliverGrid(
      ...
      delegate: SliverChildBuilderDelegate(
            ...
            (context, index) {
          var recommendation = state.movieRecommendations[index] ;
